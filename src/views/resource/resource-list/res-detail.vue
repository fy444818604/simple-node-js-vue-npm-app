...
export default {
  components:{
    ...
    resCommendBox: () => import("@/components/res-cmdBox"),
  },
  data(){
    return {
      value1:0,
...
.comments {
  ...
  .comments-info {
    ...
    .comments-info-active {
      ...
      .active-info {
        text-align: center;
        p.name {color: #606266;font-size: 16px;}
        p.btn{
          width: 120px;
          height: 36px;
    ...
    .comments-res {
      padding: 20px;
      background: #fff;
      .title {color: #303133;font-size: 16px;}
      .content {
        li {
          cursor: pointer;
          margin-top: 20px;
          ...
          .img-wrap {
            ...
            border-radius: 6px;
            margin-right: 10px;
            .time {position: absolute;right: 5px;bottom: 5px;
              padding: 0 5px;background: rgba(0, 0, 0, 0.2);color: #fff;
              border-radius: 9px;
            }
          }
          p {
