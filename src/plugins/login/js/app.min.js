$(function() {
    ...
    $(".homepage-header").vegas({
        ...
        delay: 1e4,
        slides: [{
            src: "plugins/login/img/unsplash1.jpg",
            color: "#DBC9B3",
            transition: "fade2",
            transitionDuration: 1e4
        },
        {
            src: "plugins/login/img/unsplash3.jpg",
            color: "#F6B700",
            transition: "zoomOut",
            transitionDuration: 8e3
        },
        {
            src: "plugins/login/img/unsplash2.jpg",
            color: "#C47F48",
            transition: "swirlRight"
        },
        {
            src: "plugins/login/img/unsplash5.jpg",
            color: "#EFAF41",
            animation: "random"
        },
        {
            src: "plugins/login/img/unsplash4.jpg",
            color: "#CBC2B9",
            animation: "kenburns",
            transition: "swirlLeft2"
        },
        {
            src: "plugins/login/img/unsplash8.jpg",
            color: "#ECA24D",
            animation: "random"
        },
        {
            src: "plugins/login/img/unsplash6.jpg",
            color: "#B89E2F",
            animation: "random"
        },
        {
            src: "plugins/login/img/unsplash7.jpg",
            color: "#7BBBBB",
            animation: "random",
