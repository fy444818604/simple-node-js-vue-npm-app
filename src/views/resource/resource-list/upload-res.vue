        ...
        <div class="res-info">
          <div class="left">
            ...
            <div class="relate-course">
              ...
              <el-input style="width:475px" v-model="input"
          ...
          <template v-if="showAdvance">
            <div class="advance-content">
              <div class="authty">
                <div class="visited">
                  <span>访问权限：</span>
                  <el-select v-model="accessRight.key" placeholder="请选择">
                    <el-option
                      label="公开"
                      value="gongkai">
                    </el-option>
                  ...
                  <!-- 指定机构 -->
                  <template v-if="accessRight.key === 'jigou'">
                    <el-select @focus="handleFocus" style="margin-left:15px;width:260px" v-model="accessRight.value"
                               placeholder="请选择机构">
                      <el-option
                        label="label"
                        value="value">
                  ...
                  <!-- 密码 -->
                  <template v-if="accessRight.key === 'mima'">
                    <el-input style="margin-left:15px;width:260px" placeholder="请填写密码" v-model="accessRight.value"></el-input>
                  </template>
                </div>
                <div class="down">
                  <span>下载权限：</span>
...
export default {
    ...
    data() {
        const generateData = _ => {
            ...
            const pinyin = ['shanghai', 'beijing', 'guangzhou', 'shenzhen', 'nanjing', 'xian', 'chengdu',
                'shanghai1', 'beijing1', 'guangzhou1', 'shenzhen1', 'nanjing1', 'xian1', 'chengdu1'];
    ...
    methods:{
        handleFocus(){
            this.$myLayer.formLayer('指定机构查看',$('.transfer'),['749px','536px'],() => {
